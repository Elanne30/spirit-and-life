...
function bodyOf(input: ReturnType<typeof read>) {
  return {
    ...
    relatedBookSlugs: input.relatedBookSlugs,
    relatedStudyPlanDates: input.relatedStudyPlanDates,
