...
export function ArticleForm({ draft }: Props) {
  ...
  const [category, setCategory] = useState(draft?.category ?? "Philosophy");
  ...
  return <>
    ...
    <form action={formAction} className="admin-form">
      ...
      <label htmlFor="article-category">Category</label><select id="article-category" name="category" value={category} onChange={(event) => setCategory(event.target.value)}><option value="Philosophy">Philosophy</option><option value="Apologetics">Apologetics</option><option value="Biblical Studies">Biblical Studies</option><option value="Theology">Theology</option><option value="Christian Living">Christian Living</option><option value="Faith & Life">Faith &amp; Life</option><option value="Church History">Church History</option></select>
