...
export function DraftEditForm({ draft }: { draft: ContentDraft }) {
  ...
  return (
    <form className="admin-form" action={formAction}>
      ...
      <select id="edit-content-type" name="contentType" defaultValue={draft.content_type} required>
      ...
      <select id="edit-category" name="category" defaultValue={draft.category ?? "Biblical Studies"}>
        <option value="Biblical Studies">Biblical Studies</option><option value="Theology">Theology</option><option value="Christian Living">Christian Living</option><option value="Faith & Life">Faith & Life</option><option value="Philosophy">Philosophy</option><option value="Apologetics">Apologetics</option><option value="Church History">Church History</option><option value="SCRIPTURE">SCRIPTURE</option>
      </select>
