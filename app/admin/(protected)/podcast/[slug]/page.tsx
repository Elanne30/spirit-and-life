...
export default function AdminPodcastEpisodePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  async function uploadCover(file: File) {
    ...
    try {
      const blob = await upload(`podcast/cover/${Date.now()}-${file.name}`, file, {
        access: "public",
