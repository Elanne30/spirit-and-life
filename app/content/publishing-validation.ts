...
export function ensurePublishingIntegrity() {
  ...
  for (const reflection of reflections) {
    ...
    addRelationshipErrors("Reflection", reflection.contentSlug, reflection, reflectionSlugSet, journalSlugSet, bookSlugSet, studyDateSet, errors);
  }
  ...
  for (const journal of journals) {
    ...
    addRelationshipErrors("Journal", journal.contentSlug, journal, reflectionSlugSet, journalSlugSet, bookSlugSet, studyDateSet, errors);
  }
  ...
  for (const book of books) {
    ...
    addRelationshipErrors("Book", book.contentSlug, book, reflectionSlugSet, journalSlugSet, bookSlugSet, studyDateSet, errors);
  }
  ...
  for (const scripture of scriptureReferences) {
    ...
    addRelationshipErrors("Scripture", scripture.slug, scripture, reflectionSlugSet, journalSlugSet, bookSlugSet, studyDateSet, errors);
  }
