    ...
    <div className="site-frame home-page">
      ...
      <style>{`
        ...
        @media (max-width: 900px) {
          .home-page .hero-copy { padding-right: 30%; }
          .home-page .content-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
        ...
        @media (max-width: 720px) {
          ...
          .home-page .hero-logo { margin-inline: auto; }
          .home-page .hero-introduction, .home-page .hero-supporting { margin-inline: auto; }
          .home-page .hero-actions { justify-content: center; }
          .home-page .content-grid, .home-page .home-reflection-grid, .home-page .feature-split-book { grid-template-columns: 1fr; }
          .home-page .content-card { min-height: auto; }
          ...
          .home-page .newsletter-section { grid-template-columns: 1fr; gap: 2rem; }
        }

        @media (max-width: 480px) {
          .home-page .hero h1 { font-size: clamp(3.2rem, 15vw, 4.5rem); }
